...
func (ResourceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_adacore_964a4ad104f87e2e, []int{0}
}
...
func (*MarkdownStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_adacore_964a4ad104f87e2e, []int{1}
}
...
func (*ResourceInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_adacore_964a4ad104f87e2e, []int{2}
}
...
func (*ReplyMarkdown) Descriptor() ([]byte, []int) {
	return fileDescriptor_adacore_964a4ad104f87e2e, []int{3}
}
...
func (*TokenInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_adacore_964a4ad104f87e2e, []int{4}
}
...
func init() { proto.RegisterFile("adacore.proto", fileDescriptor_adacore_964a4ad104f87e2e) }

var fileDescriptor_adacore_964a4ad104f87e2e = []byte{
	// 639 bytes of a gzipped FileDescriptorProto
	,
}
